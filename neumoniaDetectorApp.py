...
import csv
import tkcap
import tensorflow as tf #Se instala la version TF 2.15.0 ya que la actual arroja un error
tf.compat.v1.disable_eager_execution()
tf.compat.v1.experimental.output_all_intermediates(True)
from leerImagen import read_dicom_file
from PrediccionModelo import predict


class NeumoniaDetectorApp:
    def __init__(self):
        self.root = Tk()
    ...
    def run_model(self):
        ...
        self.img2 = self.img2.resize((250, 250), resample=Image.BICUBIC)
